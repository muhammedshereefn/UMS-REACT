                                ...
                                <div className="form-group d-md-flex">
                                    <div className="w-50">
                                        {/* <label className="checkbox-wrap checkbox-primary">
                                            Remember Me
                                            <input type="checkbox" onChange={changeInData} />
                                            <span className="checkmark"></span>
                                        </label> */}
                                     </div>
                                    <div className="w-50 text-md-right">
                                        {/* <a href="/password" style={{ color: '#fff' }}>Forgot Password</a> */}
                                    </div>
                                </div>
                            </form>
                            <p className="w-100 text-center">&mdash; Don't have an account &mdash;</p>
                            <div className="social d-flex text-center">
                                <a href="/register" className="px-2 py-2 mr-md-1 rounded"><span className="ion-logo-facebook mr-2"></span>Register</a>
                            </div>
                        </div>
                    </div>
                </div>
